...
/*   Updated: 2021/04/08 07:57:57 by ngontjar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_u32	ft_lcm(t_u32 a, t_u32 b);
t_u32	ft_hcf(t_u32 a, t_u32 b);
t_u32	ft_sqrt_int(t_u32 number);

t_u32	ft_issquare_int(t_u32 number);
t_u32	ft_isprime(t_u32 number);
