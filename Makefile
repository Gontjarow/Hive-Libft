...
#    Updated: 2019/10/28 12:47:05 by ngontjar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC3 = ft_islower.c ft_isupper.c ft_isspace.c ft_putstrn.c ft_strrev.c ft_print2dstr.c ft_range.c ft_strlcpy.c
...
run:
	gcc $(FLAGS) $(TESTSRC)/ft_$(file).c -lft -o $(TESTBIN)/ft_$(file)
	$(TESTBIN)/ft_$(file)
