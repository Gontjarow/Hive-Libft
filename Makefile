...
#    Updated: 2019/11/27 23:27:07 by ngontjar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC4 = ft_islower.c ft_isupper.c ft_isspace.c ft_putstrn.c ft_strrev.c ft_print2dstr.c ft_range.c ft_strlcpy.c ft_putstrn_nulls.c ft_strclen.c ft_lstfree.c ft_lstadd_back.c ft_sqrt.c ft_isprime.c ft_prime_nfactors.c ft_prime_factors.c
